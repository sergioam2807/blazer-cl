...
const contactos = [
  ...
  },
  {
    ...
    alt: "Teléfono Servicios",
    text: "+56 9 3393 3641",
    href: "https://wa.me/56933933641",
  },
  {
    icon: "/icons/phone.svg",
    alt: "Teléfono Transporte",
    text: "+56 9 7383 3905",
    ...
    <div className="py-8">
      ...
      <div className="w-full flex flex-col sm:flex-row">
        <div className="sm:w-1/3 max-w-3xl   mx-auto relative z-10">
          ...
          <Card className="sm:text-start py-8 px-8 bg-yellow-500/80">
            ...
            {contactos.map((item, idx) => (
              <div key={idx} className="ml-3 mb-4">
                {/* Título arriba si corresponde */}
                {(item.alt === "Teléfono Servicios" ||
                  item.alt === "Teléfono Transporte") && (
                  <span className="text-lg font-semibold mt-3 underline mr-8  ml-12 sm:text-start">
                    {item.alt === "Teléfono Servicios"
                      ? "Servicios"
                      : "Transporte"}
                  </span>
